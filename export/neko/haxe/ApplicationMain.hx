...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("basic-flixel-project", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("basic-flixel-project", null, 640, 480);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "basic-flixel-project";
		app.meta["name"] = "basic-flixel-project";
